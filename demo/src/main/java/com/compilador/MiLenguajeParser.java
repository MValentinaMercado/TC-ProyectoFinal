...
public class MiLenguajeParser extends Parser {
	...
	public final ProgramaContext programa() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PA) | (1L << PC) | (1L << CA) | (1L << CC) | (1L << LA) | (1L << LC) | (1L << TRUE) | (1L << FALSE) | (1L << PYC) | (1L << COMA) | (1L << IGUAL) | (1L << MAYOR) | (1L << MAYOR_IGUAL) | (1L << MENOR) | (1L << MENOR_IGUAL) | (1L << EQL) | (1L << DISTINTO) | (1L << SUM) | (1L << RES) | (1L << MUL) | (1L << DIV) | (1L << MOD) | (1L << OR) | (1L << AND) | (1L << NOT) | (1L << FOR) | (1L << WHILE) | (1L << IF) | (1L << ELSE) | (1L << INT) | (1L << CHAR) | (1L << DOUBLE) | (1L << VOID) | (1L << RETURN) | (1L << ID) | (1L << NUM) | (1L << INTEGER) | (1L << DECIMAL) | (1L << CHARACTER) | (1L << OTRO))) != 0)) {
				{
				{
				setState(10);
				token();
	...
	public static class AndTermContext extends TermContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MiLenguajeVisitor ) return ((MiLenguajeVisitor<? extends T>)visitor).visitAndTerm(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FalseLitContext extends FactorContext {
		public TerminalNode FALSE() { return getToken(MiLenguajeParser.FALSE, 0); }
		public FalseLitContext(FactorContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MiLenguajeVisitor ) return ((MiLenguajeVisitor<? extends T>)visitor).visitFalseLit(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class NotFactorContext extends FactorContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MiLenguajeVisitor ) return ((MiLenguajeVisitor<? extends T>)visitor).visitNotFactor(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class TrueLitContext extends FactorContext {
		public TerminalNode TRUE() { return getToken(MiLenguajeParser.TRUE, 0); }
		public TrueLitContext(FactorContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof MiLenguajeVisitor ) return ((MiLenguajeVisitor<? extends T>)visitor).visitTrueLit(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final TokenContext token() throws RecognitionException {
		...
		try {
			...
			setState(51);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PA) | (1L << PC) | (1L << CA) | (1L << CC) | (1L << LA) | (1L << LC) | (1L << TRUE) | (1L << FALSE) | (1L << PYC) | (1L << COMA) | (1L << IGUAL) | (1L << MAYOR) | (1L << MAYOR_IGUAL) | (1L << MENOR) | (1L << MENOR_IGUAL) | (1L << EQL) | (1L << DISTINTO) | (1L << SUM) | (1L << RES) | (1L << MUL) | (1L << DIV) | (1L << MOD) | (1L << OR) | (1L << AND) | (1L << NOT) | (1L << FOR) | (1L << WHILE) | (1L << IF) | (1L << ELSE) | (1L << INT) | (1L << CHAR) | (1L << DOUBLE) | (1L << VOID) | (1L << RETURN) | (1L << ID) | (1L << NUM) | (1L << INTEGER) | (1L << DECIMAL) | (1L << CHARACTER) | (1L << OTRO))) != 0)) ) {
	...
	public static final String _serializedATN =
		...
		"\5\3\6\3\6\3\6\2\4\4\6\7\2\4\6\b\n\2\3\4\2\3)--\29\2\17\3\2\2\2\4\24\3"+
		"\2\2\2\6\37\3\2\2\2\b\63\3\2\2\2\n\65\3\2\2\2\f\16\5\n\6\2\r\f\3\2\2\2"+
		"\16\21\3\2\2\2\17\r\3\2\2\2\17\20\3\2\2\2\20\22\3\2\2\2\21\17\3\2\2\2"+
		"\22\23\7\2\2\3\23\3\3\2\2\2\24\25\b\3\1\2\25\26\5\6\4\2\26\34\3\2\2\2"+
		"\27\30\f\4\2\2\30\31\7\31\2\2\31\33\5\6\4\2\32\27\3\2\2\2\33\36\3\2\2"+
		"\2\34\32\3\2\2\2\34\35\3\2\2\2\35\5\3\2\2\2\36\34\3\2\2\2\37 \b\4\1\2"+
		" !\5\b\5\2!\'\3\2\2\2\"#\f\4\2\2#$\7\32\2\2$&\5\b\5\2%\"\3\2\2\2&)\3\2"+
		"\2\2\'%\3\2\2\2\'(\3\2\2\2(\7\3\2\2\2)\'\3\2\2\2*+\7\33\2\2+\64\5\b\5"+
		"\2,-\7\3\2\2-.\5\4\3\2./\7\4\2\2/\64\3\2\2\2\60\64\7&\2\2\61\64\7\t\2"+
		"\2\62\64\7\n\2\2\63*\3\2\2\2\63,\3\2\2\2\63\60\3\2\2\2\63\61\3\2\2\2\63"+
		"\62\3\2\2\2\64\t\3\2\2\2\65\66\t\2\2\2\66\13\3\2\2\2\6\17\34\'\63";
